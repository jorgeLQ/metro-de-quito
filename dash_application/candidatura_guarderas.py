...
def create_dash_application4(flask_app):
    dash_app = Dash(server=flask_app, name="Dashboard", url_base_pathname="/santiagoguarderas/",external_stylesheets=[dbc.themes.BOOTSTRAP])
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            ...
                                            html.Div([
                                                html.Div([
                                                    num_P_percent_str,
                                                ],style={'background-color':'#2bc58b','color':'white','font-size': '20px','width':num_P_percent_str,'border-radius':'.25rem','height':'35px'}),
                                            ],style={'background-color':'#B0E6D1','border-radius':'.25rem','height':'35px'}),
                                        ],className='col-xl-6 col-md-6 mb-6'),
                                    ],className='row no-gutters text-center'),
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            ...
                                            html.Div([
                                                html.Div([
                                                    num_N_percent_str,
                                                ],style={'background-color':'#f44d4d','color':'white','font-size': '20px','width':num_N_percent_str,'border-radius':'.25rem','height':'35px'}),
                                            ],style={'background-color':'#E4CACA','border-radius':'.25rem','height':'35px'}),
                                        ],className='col-xl-6 col-md-6 mb-6'),
                                    ],className='row no-gutters text-center'),
                                ],className='card-body'),
                            ],className='card shadow h-100 py-2'),
